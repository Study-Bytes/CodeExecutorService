...
По умолчанию сервис стартует на `http://localhost:8084`.
...
- Method: `POST`
- URL: `http://localhost:8084/executions`
...
- Method: `POST`
- URL: `http://localhost:8084/executions/<SESSION_UUID>/tests`
- Header: `Content-Type: application/json`
...
```http
POST http://localhost:8084/executions/<SESSION_UUID>/tests
```
...
- Method: `GET`
- URL: `http://localhost:8084/executions/<SESSION_UUID>`
...
- Method: `POST`
- URL: `http://localhost:8084/executions/<SESSION_UUID>/cancel`
...
- Method: `POST`
- URL: `http://localhost:8084/executions/batch`
- Header: `Content-Type: application/json`
